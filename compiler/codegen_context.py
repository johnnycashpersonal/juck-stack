...
class Context(object):
    ...
    def __init__(self) -> None:
        ...
        # A table of integer constants to be declared at the end of the source program.  The table maps values to names, so that we can reuse them.
        self.consts: dict[str, int] = {}
    
        # A table of variables to be declared at the end of the source program, with the symbols used for them in the assembly code.
